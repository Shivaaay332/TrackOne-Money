    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-dark-bg p-4 transition-colors duration-300">
      ...
      >
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-primary-500 to-blue-500 mb-2">TrackOne Money</h1>
          <p className="text-gray-500 dark:text-gray-400">Sign in to manage your finances</p>
        </div>

        {errorMsg && (
          <div className="mb-6 flex items-center p-4 text-sm text-red-800 border border-red-300 rounded-lg bg-red-50 dark:bg-red-900/20 dark:text-red-400 dark:border-red-800">
