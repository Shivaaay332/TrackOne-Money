        ...
        <div className="flex flex-col sm:flex-row items-center space-y-3 sm:space-y-0 sm:space-x-3 w-full lg:w-auto">
          <div className="relative w-full sm:w-auto">
            <select 
              ...
              className="w-full appearance-none bg-white dark:bg-dark-card border border-gray-200 dark:border-dark-border text-gray-700 dark:text-gray-200 py-2.5 pl-4 pr-8 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary-500 shadow-sm cursor-pointer text-sm font-medium"
            >
          ...
          <button 
            ...
            className="w-full sm:w-auto flex items-center justify-center space-x-2 bg-gradient-to-r from-primary-600 to-primary-500 hover:from-primary-700 hover:to-primary-600 text-white py-2.5 px-6 rounded-xl shadow-md transition-all font-semibold disabled:opacity-70 whitespace-nowrap"
          >
